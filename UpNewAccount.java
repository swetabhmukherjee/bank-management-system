...
import java.sql.*;
import javax.swing.*;
public class UpNewAccount extends Frame implements ActionListener
{
	...
	{
		/*UpNewAccount ua=new UpNewAccount();
		ua.job();*/
	}
	public UpNewAccount(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8)
	{
		this.s1=s1;
		this.s2=s2;
		this.s3=s3;
	...
	public void job()
	{
		...
		add(tf8);
		tf8.setText(s8);
		b1.setBounds(400,90,100,25);
		add(b1);
		b2.setBounds(400,250,100,25);
		add(b2);
		b3.setBounds(400,300,100,25);
		add(b3);
		b4.setBounds(400,350,100,25);
		add(b4);
		b5.setBounds(220,500,100,25);
		add(b5);
	...
	public void actionPerformed (ActionEvent ae)
	{
		...
		if (ae.getSource()==b5)
		{
			...
			s7=tf7.getText();
			{
				JOptionPane.showMessageDialog(frame,"Your account has been updated successfully", "Information", JOptionPane.INFORMATION_MESSAGE);		
			}
			try
			{
				...
				str="update accounts set Name='"+s2+"',Address='"+s5+"',Mob_no='"+s6+"',Email='"+s7+"' where Account_no='"+s1+"'";
